...
ENFORCE S14_REGIME_GATE_SHADOW: buckets only + one System One call + label compose; never place.
ENFORCE S15_COST_OF_ERROR: tape costs + CONF_GATE shadow bands beside ADM/SIZ; vendor 0.85 is not truth; never place.
ENFORCE S16_MULTI_STAGE_GUARD: Dig/Chair five-screen tool wrap; DONE_OUTSIDE twin; CONF_GATE law; never place.
ENFORCE JEV_EVERYWHERE: Choice/Score/Noul on every safe decision site; same jev_fluid_gate_v1 sidecar; never place.
