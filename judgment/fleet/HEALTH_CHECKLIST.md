...
| 2 | `mirror_fanout.targets` is `observer_sh`, `observer_redacted_account`, `observer_redacted_account` | redacted_account present |
| 3 | SH 0 @ `C:\MT5\FTMO_Trial` bal/eq readable, pos integer | `--mt5` |
