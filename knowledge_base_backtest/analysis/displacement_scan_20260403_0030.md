...
- **4** candidate edges found in discovery
- **4** patterns replicated on validation data
...
| Value | n | 3h | MFE | MAE | Effect |
|-------|---|----|----|-------|--------|
| False | 2315 | 51.1% | $6.5 | $6.1 | +2.4% |
| True | 1014 | 43.2% | $7.5 | $8.4 | -5.5% |
...
**breaks_ob:** (baseline=48.7%)
| Value | n | 3h | MFE | MAE | Effect |
|-------|---|----|----|-------|--------|
| False | 3247 | 48.8% | $6.8 | $6.8 | +0.1% |
| True | 82 | 45.1% | $6.1 | $8.6 | -3.5% |

**consol_bucket:** (baseline=48.7%)
| Value | n | 3h | MFE | MAE | Effect |
|-------|---|----|----|-------|--------|
| 0.7-1.0 | 1250 | 47.9% | $6.5 | $6.4 | -0.7% |
| >1.0 | 1076 | 49.6% | $7.2 | $7.1 | +1.0% |
| 0.4-0.7 | 953 | 48.3% | $6.7 | $7.0 | -0.4% |
| <0.4 | 50 | 54.0% | $6.4 | $5.7 | +5.3% |
...
| Value | n | 3h | MFE | MAE | Effect |
|-------|---|----|----|-------|--------|
| >1.0 | 1699 | 48.9% | $6.9 | $7.1 | +0.2% |
| 0.7-1.0 | 1016 | 48.8% | $6.7 | $6.4 | +0.2% |
| 0.4-0.7 | 579 | 47.8% | $6.6 | $6.9 | -0.8% |
| <0.4 | 35 | 45.7% | $6.4 | $6.9 | -2.9% |
...
|-------------|---|----|-----|-----|---------|------------|
| FVG+Align>=3 | 25 | 64.0% | $11.2 | $6.8 | 1.6x | **YES** |
| Sweep+FVG+Align>=3 | 22 | 63.6% | $12.0 | $6.9 | 1.7x | **YES** |
| Sweep+Align>=3 | 28 | 60.7% | $10.8 | $7.6 | 1.4x | **YES** |
| CT+3rd+Exhaust | 40 | 55.0% | $7.5 | $5.6 | 1.3x | **YES** |
...
| Sweep+1st+Align>=2 | 170 | 54.7% | 217 | 57.1% | not rep |
...
| Tight+KZ+Align>=2 | 2 | 0.0% | 2 | 0.0% | not rep |
...
## Section 7: AI System Comparison

**AI Trade Data:** 111 trades across 88 unique dates
- AI trades/month: 5.0

**Overlap:** 101/111 AI trades (91%) had a matching displacement in the same KZ + direction

**Quality Comparison (AI trade dates vs all displacements):**
| Metric | AI Trade Dates | All Displacements |
|--------|----------------|-------------------|
| Avg alignment | 1.35 | 0.72 |
| Sweep rate | 98% | 88% |
| FVG rate | 85% | 62% |

**Missed Opportunities:** 122 qualifying displacements on 82 non-AI dates
- Qualifying = in KZ + alignment>=2 + sweep detected
- Estimated additional: **5.5 setups/month**
- Continuation rate on missed: 43.4%
- Avg MFE on missed: $12.5 (MAE: $16.7)
...
5. **Additional trades available:** ~5.5 qualifying displacement setups/month on non-AI dates (vs 5.0 current AI trades/month).

### Methodology Notes
- `origin_revisited=False` excluded from flagged factors (tautology: no pullback = price kept moving = continuation by definition)
- Candidate edge threshold: cont>=55% AND MFE>1.3*MAE AND n>=20 (same for discovery and validation)

### Fix 1 Verification: Tightness Distribution
- **Tightness 5-candle:** <0.4=72 (1.1%), 0.4-0.7=1170 (17.6%), 0.7-1.0=2088 (31.4%), >1.0=3311 (49.9%)
- **Consolidation 10-candle:** <0.4=78 (1.2%), 0.4-0.7=1929 (29.0%), 0.7-1.0=2550 (38.4%), >1.0=2084 (31.4%)
