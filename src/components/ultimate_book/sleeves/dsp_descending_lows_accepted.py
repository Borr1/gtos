    ...
    if timing_fact:
        try:
            ...
            if fear_withholds(
                ...
                "The descending-lows pattern already printed on this bar, and a second timing check is true. Is the pattern the intent, or does timing still withhold it? Do not close ticket 294215389.",
            ):
                fear_hold = True
        except Exception:
            pass
