...
def _ask(
    ...
    threshold = _score_of(answers.get(f"a1_{stage}_threshold"))
    parameter = _score_of(answers.get(f"a1_{stage}_parameter"))
    loop_bound = _score_of(answers.get(f"a1_{stage}_loop"))
