...
# Sealed Challenge 45-pack measurements. Tape records, not live parameters.
CHALLENGE_N = 45
CHALLENGE_XAU_N = 21
CHALLENGE_XAU_NET = -814.94
CHALLENGE_XAU_TIME_STOP_WINS = 5
CHALLENGE_XAU_ORIG_STOP_LOSSES = 16
CHALLENGE_ADMIT_THEN_FLIP_N = 15
CHALLENGE_ADMIT_THEN_FLIP_RATE = 15 / 45
CHALLENGE_ADMIT_NOW_FLIP_N = 0
CHALLENGE_API_VS_DERIVED_THEN = 0.005444
CHALLENGE_API_VS_DERIVED_NOW = 0.004556
CHALLENGE_NOUL_VS_P_ADMIT_THEN = 0.2116
CHALLENGE_DELAY_AS_WALL_R = 6.5992
CHALLENGE_XAU_ADMIT_THEN = {"hard_refuse": 13, "admit": 8}
CHALLENGE_XAU_ADMIT_NOW = {"admit": 20, "hard_refuse": 1}
CHALLENGE_SPRING_TICKET = 291794419
CHALLENGE_SPRING_THEN_CONF = 0.21
CHALLENGE_SPRING_THEN_P_ADMIT = 0.47
CHALLENGE_SPRING_THEN_MARGIN = 0.05
CHALLENGE_WINNER_TICKETS = (
    291794419,
    292427064,
    292667008,
    292885676,
...
CHALLENGE_ORDER_SENSITIVE_WINNERS = (
    291794419,
    292427064,
    292667008,
)
DO_NOT_REMINT = 291096187
...
def _score_question(qid: str, text: str, criteria: Sequence[str]) -> dict[str, Any]:
    instructions = _scrub_text(text)
    levels = [str(item) for item in criteria] if criteria else list(_BETWEEN)
    body: dict[str, Any] = {"type": "score", "instructions": instructions, "criteria": levels}
    try:
