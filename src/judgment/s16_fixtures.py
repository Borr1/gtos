...
from .s16_flags import APPLY_ENV, default_s16_fixtures_dir, s16_apply_env_set
...
def run_s16_fixture(
    ...
    *,
    ...
    if s16_apply_env_set(environ=environ):
        raise RuntimeError(f"{APPLY_ENV} is forbidden after Dig E KILL")
