...
PRIORITY_LEDGER = ROUTE_DIR / f"MAIN_ORCH48_MOONSHOT_REDUCED_SURFACE_SOURCE_CAPTURE_PRIORITY_LEDGER_{DATE}.jsonl"
OUTPUT_LEDGER = ROUTE_DIR / f"MAIN_ORCH48_MOONSHOT_REDUCED_SURFACE_EVENT_EMITTER_CONTRACT_LEDGER_{DATE}.jsonl"
OUTPUT_SUMMARY = ROUTE_DIR / f"MAIN_ORCH48_MOONSHOT_REDUCED_SURFACE_EVENT_EMITTER_CONTRACT_SUMMARY_{DATE}.json"
OUTPUT_MANIFEST = (
    ROUTE_DIR / f"MAIN_ORCH48_MOONSHOT_REDUCED_SURFACE_EVENT_EMITTER_CONTRACT_OUTPUT_MANIFEST_{DATE}.json"
)
...
def build() -> dict[str, Any]:
    ...
    contracts = [
        reduced_surface_event_emitter_contract_for_priority_group(
            priority,
            contract_row_id=f"MAIN-ORCH48-MOONSHOT-REDUCED-SURFACE-EVENT-EMITTER-CONTRACT-{index:08d}",
    ...
    summary = {
        ...
        "schema_version": "main_orch48_moonshot_reduced_surface_event_emitter_contracts_v1",
