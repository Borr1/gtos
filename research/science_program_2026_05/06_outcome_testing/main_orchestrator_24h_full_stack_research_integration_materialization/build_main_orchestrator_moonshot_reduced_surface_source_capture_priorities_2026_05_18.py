...
OUTPUT_LEDGER = ROUTE_DIR / f"MAIN_ORCH48_MOONSHOT_REDUCED_SURFACE_SOURCE_CAPTURE_PRIORITY_LEDGER_{DATE}.jsonl"
OUTPUT_SUMMARY = ROUTE_DIR / f"MAIN_ORCH48_MOONSHOT_REDUCED_SURFACE_SOURCE_CAPTURE_PRIORITY_SUMMARY_{DATE}.json"
OUTPUT_MANIFEST = (
    ROUTE_DIR / f"MAIN_ORCH48_MOONSHOT_REDUCED_SURFACE_SOURCE_CAPTURE_PRIORITY_OUTPUT_MANIFEST_{DATE}.json"
)
...
def build() -> dict[str, Any]:
    ...
    summary = {
        ...
        "schema_version": "main_orch48_moonshot_reduced_surface_source_capture_priorities_v1",
    ...
    return {
        ...
        "expected_candidate_event_rows": summary["expected_candidate_event_rows"],
    }
