# Capture Contract Exactness Audit

```json
{
  "artifact_family": "capture_contract_exactness_audit",
  ...
  "forbidden_surface_contract_gaps": [],
  "generated_at_utc": "2026-05-12T02:04:08Z",
  "live_effect": false,
  "missing_capture_groups": [],
  ...
  "vague_or_missing_contract_entries": [],
