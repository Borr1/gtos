...
def _rowset_row() -> dict:
    return {
        ...
        "card_predicate_id": "ADV001_SESSION_TIME_PLACEBO_CONTRAST_V1",
        "card_row_status": "PASS_DESCRIPTOR_CONTRAST_ELIGIBLE",
        "denominator_role": "per_card_pass_row",
        "descriptor_contrast_key": "GLOBAL_OFF_SESSION_OR_TRANSITION|UTC_18_23|EURUSD",
        "descriptor_values": {"session_bucket": "GLOBAL_OFF_SESSION_OR_TRANSITION"},
        "source_fields_consumed": ["candidate_input_row_id"],
        "fail_closed_reasons": [],
        "missing_source_requirements": [],
        "status_reason": "session_time_symbol_placebo_cell",
        ...
        "source_segment_sha256": "segment-sha",
...
def test_computed_row_has_no_forbidden_exact_fields_and_safe_flags_closed() -> None:
    ...
    assert row["card_row_status"] == "PASS_DESCRIPTOR_CONTRAST_ELIGIBLE"
    assert row["denominator_role"] == "per_card_pass_row"
