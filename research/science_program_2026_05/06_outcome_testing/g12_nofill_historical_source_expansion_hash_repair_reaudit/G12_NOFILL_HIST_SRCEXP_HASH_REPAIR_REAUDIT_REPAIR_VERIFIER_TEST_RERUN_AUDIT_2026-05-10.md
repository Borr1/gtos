# Repair Verifier Test Rerun Audit
...
```json
{
  ...
  "checks": {
    "repair_focused_pytest_passed": true,
    "repair_focused_pytest_was_run": true,
    "repair_verifier_passed": true,
    "repair_verifier_was_run": true
  },
  "credentials_touched": false,
  "generated_at_utc": "2026-05-10T06:17:08Z",
  "live_effect": false,
  ...
  "remaining_blockers": [],
  "repair_focused_pytest_run": {
    "command": [
      "C:\\Python313\\python.exe",
      "-m",
      "pytest",
      "C:\\tmp\\gtos_otb\\G12NOFILLHASHREPAIR\\research\\science_program_2026_05\\06_outcome_testing\\nofill_historical_source_expansion_packet_parser_hash_repair_rebuild\\test_nofill_historical_source_expansion_packet_parser_hash_repair_rebuild_2026_05_10.py",
      "-q",
      "-p",
      "no:cacheprovider"
    ],
    "completed_at_utc": "2026-05-10T06:17:08Z",
    "returncode": 0,
    "started_at_utc": "2026-05-10T06:17:07Z",
    "stderr_tail": "",
    "stdout_tail": ".....                                                                    [100%]\n5 passed in 0.39s\n"
  },
  "repair_verifier_run": {
