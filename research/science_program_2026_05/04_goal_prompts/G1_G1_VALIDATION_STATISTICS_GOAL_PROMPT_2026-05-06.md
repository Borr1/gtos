# G1 Validation Probability Statistics Causality Goal Prompt - 2026-05-06

**Role:** `science_lane`
**Domain:** `validation, probability, statistics, causality`
**Promotion verdict:** `NO_PROMOTION_VERDICT`
**Worktree:** `C:\tmp\gtosg\G1`
**Branch:** `science-goals/g1-validation-statistics`

## Objective

Extract mechanisms from DSR/PBO/effective-N, CPCV, causal inference, leakage control, multiple testing, power analysis, and sample-floor policy.
...
After the first synthesis pass, read outputs from neighboring lanes: G2, G9, G10. Add only cross-domain hypotheses that survive source, leakage, and killed-route checks.
...
Do not mark `G1` complete until files exist, focused checks are recorded, blockers are explicit, and every row/report carries `NO_PROMOTION_VERDICT`.
