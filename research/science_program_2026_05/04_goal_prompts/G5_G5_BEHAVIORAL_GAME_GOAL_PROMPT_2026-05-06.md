# G5 Behavioral Finance Psychology Game Theory Goal Prompt - 2026-05-06

**Role:** `science_lane`
**Domain:** `behavioral finance, psychology, game theory`
**Promotion verdict:** `NO_PROMOTION_VERDICT`
**Worktree:** `C:\tmp\gtosg\G5`
**Branch:** `science-goals/g5-behavioral-game`

## Objective

Translate herding, crowded trendline/ICT behavior, adaptive markets, predatory trading, forced flow, and reactions to news/AI into measurable mechanisms.
...
After the first synthesis pass, read outputs from neighboring lanes: G4, G6, G7. Add only cross-domain hypotheses that survive source, leakage, and killed-route checks.
...
Do not mark `G5` complete until files exist, focused checks are recorded, blockers are explicit, and every row/report carries `NO_PROMOTION_VERDICT`.
