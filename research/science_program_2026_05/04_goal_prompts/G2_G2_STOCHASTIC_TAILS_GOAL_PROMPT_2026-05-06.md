# G2 Stochastic Processes Time Series Tails Goal Prompt - 2026-05-06

**Role:** `science_lane`
**Domain:** `stochastic processes, time series, tails`
**Promotion verdict:** `NO_PROMOTION_VERDICT`
**Worktree:** `C:\tmp\gtosg\G2`
**Branch:** `science-goals/g2-stochastic-tails`

## Objective

Extract mechanisms from SDEs, Markov/HMM state models, GARCH/EVT, rough volatility, drawdown/tail risk, hazard models, and survival timing.
...
After the first synthesis pass, read outputs from neighboring lanes: G1, G3, G10. Add only cross-domain hypotheses that survive source, leakage, and killed-route checks.
...
Do not mark `G2` complete until files exist, focused checks are recorded, blockers are explicit, and every row/report carries `NO_PROMOTION_VERDICT`.
