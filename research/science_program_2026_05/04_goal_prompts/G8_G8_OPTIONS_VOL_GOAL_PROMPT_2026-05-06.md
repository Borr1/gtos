# G8 Options Gamma Volatility Risk Premium Goal Prompt - 2026-05-06

**Role:** `science_lane`
**Domain:** `options, gamma, volatility risk premium`
**Promotion verdict:** `NO_PROMOTION_VERDICT`
**Worktree:** `C:\tmp\gtosg\G8`
**Branch:** `science-goals/g8-options-vol`

## Objective

Translate GEX, dealer hedging, VIX1D/VIX9D, GVZ/VVIX, VRP construction, and OPEX regimes into source-contracted shadow hypotheses.
...
After the first synthesis pass, read outputs from neighboring lanes: G2, G7, G10. Add only cross-domain hypotheses that survive source, leakage, and killed-route checks.
...
Do not mark `G8` complete until files exist, focused checks are recorded, blockers are explicit, and every row/report carries `NO_PROMOTION_VERDICT`.
