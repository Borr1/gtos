# G3 Geometry Fractals Signal Processing Goal Prompt - 2026-05-06

**Role:** `science_lane`
**Domain:** `geometry, fractals, signal processing`
**Promotion verdict:** `NO_PROMOTION_VERDICT`
**Worktree:** `C:\tmp\gtosg\G3`
**Branch:** `science-goals/g3-geometry-signal`

## Objective

Translate swings, directional change, wavelets, Fourier/spectral coherence, Hurst, multifractal, and measurable topology ideas into GTOS hypotheses.
...
After the first synthesis pass, read outputs from neighboring lanes: G2, G4, G6. Add only cross-domain hypotheses that survive source, leakage, and killed-route checks.
...
Do not mark `G3` complete until files exist, focused checks are recorded, blockers are explicit, and every row/report carries `NO_PROMOTION_VERDICT`.
