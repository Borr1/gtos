# G11 Data Sources And Market Expansion Goal Prompt - 2026-05-06

**Role:** `science_lane`
**Domain:** `data sources and market expansion`
**Promotion verdict:** `NO_PROMOTION_VERDICT`
**Worktree:** `C:\tmp\gtosg\G11`
**Branch:** `science-goals/g11-data-sources-expansion`

## Objective

Govern Sierra/Databento/source contracts, new instruments, observer lanes, data-quality bias, legality, cost, and freshness without turning expansion into a promotion claim.
...
After the first synthesis pass, read outputs from neighboring lanes: G4, G7, G8. Add only cross-domain hypotheses that survive source, leakage, and killed-route checks.
...
Do not mark `G11` complete until files exist, focused checks are recorded, blockers are explicit, and every row/report carries `NO_PROMOTION_VERDICT`.
