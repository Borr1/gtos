# G9 AI ML RL LLM Trading Systems Goal Prompt - 2026-05-06

**Role:** `science_lane`
**Domain:** `AI, ML, RL, LLM trading systems`
**Promotion verdict:** `NO_PROMOTION_VERDICT`
**Worktree:** `C:\tmp\gtosg\G9`
**Branch:** `science-goals/g9-ai-ml-systems`

## Objective

Map K55 target/model paths, no-leak feature bundles, classical-vs-LLM comparisons, tool grounding, debate, and Reflexion into shadow-only experiments.
...
After the first synthesis pass, read outputs from neighboring lanes: G1, G4, G10. Add only cross-domain hypotheses that survive source, leakage, and killed-route checks.
...
Do not mark `G9` complete until files exist, focused checks are recorded, blockers are explicit, and every row/report carries `NO_PROMOTION_VERDICT`.
