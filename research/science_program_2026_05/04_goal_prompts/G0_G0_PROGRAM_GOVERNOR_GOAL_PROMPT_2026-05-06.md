# G0 Program Governor Goal Prompt - 2026-05-06

**Role:** `coordinator`
**Domain:** `research governance`
**Promotion verdict:** `NO_PROMOTION_VERDICT`
**Worktree:** `C:\tmp\gtosg\G0`
**Branch:** `science-goals/g0-program-governor`

## Objective

Own worktree map, master registry, source/budget ledger, merge discipline, stale-route checks, lane reconciliation, and final synthesis.
...
After the first synthesis pass, read outputs from neighboring lanes: G1, G4, G9. Add only cross-domain hypotheses that survive source, leakage, and killed-route checks.
...
Do not mark `G0` complete until files exist, focused checks are recorded, blockers are explicit, and every row/report carries `NO_PROMOTION_VERDICT`.
