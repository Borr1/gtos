# G7 Macro Cross Asset Rates FX Gold Goal Prompt - 2026-05-06

**Role:** `science_lane`
**Domain:** `macro, cross-asset, rates, FX, gold`
**Promotion verdict:** `NO_PROMOTION_VERDICT`
**Worktree:** `C:\tmp\gtosg\G7`
**Branch:** `science-goals/g7-macro-cross-asset`

## Objective

Translate DXY, yields, real rates, COT, BIS/FRED/Fed, LBMA/fix effects, gold/silver/index/JPY/GBP context into source-aware hypotheses.
...
After the first synthesis pass, read outputs from neighboring lanes: G5, G8, G11. Add only cross-domain hypotheses that survive source, leakage, and killed-route checks.
...
Do not mark `G7` complete until files exist, focused checks are recorded, blockers are explicit, and every row/report carries `NO_PROMOTION_VERDICT`.
