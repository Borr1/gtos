# Wave3 Lane 14: Partial BE Trailing Stale-Thesis Exit Policy V4

You are the Wave3 `partial_be_trailing_stale_thesis_exit_policy_v4` goal session for GTOS final moonshot after the broker-real hard halt.
...
- Launch order: `14`
- Branch: `wave3-partial-be-trailing-stale-thesis-exit-policy-v4-2026-06-04`
- Worktree: `/Users/borr/Documents/gtos/worktrees/wave3-partial-be-trailing-stale-thesis-exit-policy-v4-2026-06-04`
- Route directory: `research/operations/wave3_partial_be_trailing_stale_thesis_exit_policy_v4_2026_06_04`
...
```json
{
  ...
  "derived_from_question_ids": [
    "W2Q_LOSER_MFE_HARVEST",
    "W2Q_STATIC_R_GEOMETRY",
    "W2Q_SAME_SYMBOL_LIFECYCLE"
  ],
...
implement exit policies that release risk, protect meaningful profit, and close stale theses using source-bound path, cost, time, ticket, and broker lifecycle evidence.
...
- `python3 scripts/audit_goal_route_artifacts.py research/operations/wave3_partial_be_trailing_stale_thesis_exit_policy_v4_2026_06_04 --full-jsonl` after creating the route directory.
