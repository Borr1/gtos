# Wave3 Lane 02: Data Capture Source Repair Final And LiveDecisionPacket V4

You are the Wave3 `data_capture_source_repair_final_and_livedecisionpacket_v4` goal session for GTOS final moonshot after the broker-real hard halt.
...
- Route directory: `research/operations/wave3_data_capture_source_repair_final_and_livedecisionpacket_v4_2026_06_04`
...
implement LiveDecisionPacketV4 capture so selector, allocator, execution, cost, lifecycle, probability, confluence, broker, halt, and AI fields become first-class source truth.
...
- `python3 scripts/audit_goal_route_artifacts.py research/operations/wave3_data_capture_source_repair_final_and_livedecisionpacket_v4_2026_06_04 --full-jsonl` after creating the route directory.
