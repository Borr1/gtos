# Wave3 Lane 04: Probability Debate-Team Engine V4

You are the Wave3 `probability_debate_team_engine_v4` goal session for GTOS final moonshot after the broker-real hard halt.
...
- Launch order: `4`
- Branch: `wave3-probability-debate-team-engine-v4-2026-06-04`
- Worktree: `/Users/borr/Documents/gtos/worktrees/wave3-probability-debate-team-engine-v4-2026-06-04`
- Route directory: `research/operations/wave3_probability_debate_team_engine_v4_2026_06_04`
...
```json
{
  ...
  "derived_from_question_ids": [
    "W2Q_PROBABILITY_DEBATE_ENGINE",
    "W2Q_SELECTOR_QUALITY",
    "W2Q_REJECT_SKIP_ZERO_TRADE"
  ],
...
produce calibrated numeric competing theses and debate-team action selection for long, short, no-trade, wait, scale, reduce, close, and reverse before downstream gates can approve risk.
...
- `python3 scripts/audit_goal_route_artifacts.py research/operations/wave3_probability_debate_team_engine_v4_2026_06_04 --full-jsonl` after creating the route directory.
