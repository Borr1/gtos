# Wave3 Lane 08: Cost Swap Slippage Broker Constraint Engine

You are the Wave3 `cost_swap_slippage_broker_constraint_engine` goal session for GTOS final moonshot after the broker-real hard halt.
...
- Route directory: `research/operations/wave3_cost_swap_slippage_broker_constraint_engine_2026_06_04`
...
make spread, commission, swap, slippage, broker hours, symbol specs, and account profile hard broker-net inputs before selector, allocator, execution, and exits approve risk.
...
- `python3 scripts/audit_goal_route_artifacts.py research/operations/wave3_cost_swap_slippage_broker_constraint_engine_2026_06_04 --full-jsonl` after creating the route directory.
