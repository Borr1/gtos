# Wave3 Lane 17: Validation Anti-Overfit V4

You are the Wave3 `validation_anti_overfit_v4` goal session for GTOS final moonshot after the broker-real hard halt.
...
- Launch order: `17`
- Branch: `wave3-validation-anti-overfit-v4-2026-06-04`
- Worktree: `/Users/borr/Documents/gtos/worktrees/wave3-validation-anti-overfit-v4-2026-06-04`
- Route directory: `research/operations/wave3_validation_anti_overfit_v4_2026_06_04`
...
turn Wave2 contracts into sealed historical validation, stress, holdout, perturbation, calibration, concentration, and multiple-testing controls before any production-return claim.
...
- `python3 scripts/audit_goal_route_artifacts.py research/operations/wave3_validation_anti_overfit_v4_2026_06_04 --full-jsonl` after creating the route directory.
