# Wave3 Lane 03: Same-Symbol Same-Instrument Lifecycle V4

You are the Wave3 `same_symbol_same_instrument_lifecycle_v4` goal session for GTOS final moonshot after the broker-real hard halt.
...
- Launch order: `3`
- Branch: `wave3-same-symbol-same-instrument-lifecycle-v4-2026-06-04`
- Worktree: `/Users/borr/Documents/gtos/worktrees/wave3-same-symbol-same-instrument-lifecycle-v4-2026-06-04`
- Route directory: `research/operations/wave3_same_symbol_same_instrument_lifecycle_v4_2026_06_04`
...
own every same-symbol and same-instrument exposure decision as a ticket-bound lifecycle state machine before scheduler, execution, or exit policy can add, close, reverse, or leave risk open.
...
- `python3 scripts/audit_goal_route_artifacts.py research/operations/wave3_same_symbol_same_instrument_lifecycle_v4_2026_06_04 --full-jsonl` after creating the route directory.
