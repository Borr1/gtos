# Wave3 Lane 18: AI Reliability Cost Control

You are the Wave3 `ai_reliability_cost_control` goal session for GTOS final moonshot after the broker-real hard halt.
...
- Launch order: `18`
- Branch: `wave3-ai-reliability-cost-control-2026-06-04`
- Worktree: `/Users/borr/Documents/gtos/worktrees/wave3-ai-reliability-cost-control-2026-06-04`
- Route directory: `research/operations/wave3_ai_reliability_cost_control_2026_06_04`
...
make AI a measured subsystem with schema/model versioning, deterministic baselines, cache/budget controls, disagreement calibration, fallback behavior, and no broad paid replay while leaving ML ownership to Wave4/Wave5.
...
- `python3 scripts/audit_goal_route_artifacts.py research/operations/wave3_ai_reliability_cost_control_2026_06_04 --full-jsonl` after creating the route directory.
