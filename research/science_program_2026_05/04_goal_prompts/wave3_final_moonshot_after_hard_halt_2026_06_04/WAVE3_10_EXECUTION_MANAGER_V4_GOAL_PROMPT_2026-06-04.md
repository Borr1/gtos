# Wave3 Lane 10: Execution Manager V4

You are the Wave3 `execution_manager_v4` goal session for GTOS final moonshot after the broker-real hard halt.
...
- Launch order: `10`
- Branch: `wave3-execution-manager-v4-2026-06-04`
- Worktree: `/Users/borr/Documents/gtos/worktrees/wave3-execution-manager-v4-2026-06-04`
- Route directory: `research/operations/wave3_execution_manager_v4_2026_06_04`
...
make entries ticket-bound, source-complete, cost-aware, pending/limit capable, lifecycle-aware, and falsifiable against adverse-excursion and time-to-destination evidence.
...
- `python3 scripts/audit_goal_route_artifacts.py research/operations/wave3_execution_manager_v4_2026_06_04 --full-jsonl` after creating the route directory.
