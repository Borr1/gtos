# Wave3 Lane 12: Dynamic Target Stop Thesis-Horizon Geometry V4

You are the Wave3 `dynamic_target_stop_thesis_horizon_geometry_v4` goal session for GTOS final moonshot after the broker-real hard halt.
...
- Route directory: `research/operations/wave3_dynamic_target_stop_thesis_horizon_geometry_v4_2026_06_04`
...
replace ambiguous fixed-R semantics with source-bound target, stop, invalidation, destination, thesis horizon, and modification lifecycle authority.
...
- `python3 scripts/audit_goal_route_artifacts.py research/operations/wave3_dynamic_target_stop_thesis_horizon_geometry_v4_2026_06_04 --full-jsonl` after creating the route directory.
