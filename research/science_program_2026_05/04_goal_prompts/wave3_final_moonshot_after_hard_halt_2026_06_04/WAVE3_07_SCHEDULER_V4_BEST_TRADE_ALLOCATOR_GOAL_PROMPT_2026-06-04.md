# Wave3 Lane 07: Scheduler V4 Best-Trade Allocator

You are the Wave3 `scheduler_v4_best_trade_allocator` goal session for GTOS final moonshot after the broker-real hard halt.
...
- Route directory: `research/operations/wave3_scheduler_v4_best_trade_allocator_2026_06_04`
...
replace one-candidate-at-a-time allocation with a money-risk allocator that compares new candidates, open positions, pending orders, same-symbol lifecycle actions, zero-trade, cluster risk, and stale exposure.
...
- `python3 scripts/audit_goal_route_artifacts.py research/operations/wave3_scheduler_v4_best_trade_allocator_2026_06_04 --full-jsonl` after creating the route directory.
