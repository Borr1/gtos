# Wave3 Lane 15: Dual Broker Runtime Contract

You are the Wave3 `dual_broker_runtime_contract` goal session for GTOS final moonshot after the broker-real hard halt.
...
- Launch order: `15`
- Branch: `wave3-dual-broker-runtime-contract-2026-06-04`
- Worktree: `/Users/borr/Documents/gtos/worktrees/wave3-dual-broker-runtime-contract-2026-06-04`
- Route directory: `research/operations/wave3_dual_broker_runtime_contract_2026_06_04`
...
implement source-broker and target-broker namespace separation so redacted_account may inform source-brain research while FTMO remains broker-local truth with no copied lots/fills/cash/specs.
...
- `python3 scripts/audit_goal_route_artifacts.py research/operations/wave3_dual_broker_runtime_contract_2026_06_04 --full-jsonl` after creating the route directory.
