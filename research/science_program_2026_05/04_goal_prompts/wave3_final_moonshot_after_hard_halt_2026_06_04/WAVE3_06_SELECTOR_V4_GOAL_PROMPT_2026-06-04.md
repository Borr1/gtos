# Wave3 Lane 06: Selector V4

You are the Wave3 `selector_v4` goal session for GTOS final moonshot after the broker-real hard halt.
...
- Lane: `selector_v4`
- Launch order: `6`
- Branch: `wave3-selector-v4-2026-06-04`
- Worktree: `/Users/borr/Documents/gtos/worktrees/wave3-selector-v4-2026-06-04`
- Route directory: `research/operations/wave3_selector_v4_2026_06_04`
...
build broker-net admission authority that consumes numeric confluence and probability debate output before emitting trade, no-trade, source-required, reduce-risk, queue, or reject decisions.
...
- `python3 scripts/audit_goal_route_artifacts.py research/operations/wave3_selector_v4_2026_06_04 --full-jsonl` after creating the route directory.
