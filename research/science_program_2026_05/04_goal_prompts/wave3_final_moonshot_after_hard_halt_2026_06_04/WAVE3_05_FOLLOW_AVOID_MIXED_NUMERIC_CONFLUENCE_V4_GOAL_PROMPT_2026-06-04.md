# Wave3 Lane 05: FOLLOW AVOID MIXED Numeric Confluence V4

You are the Wave3 `follow_avoid_mixed_numeric_confluence_v4` goal session for GTOS final moonshot after the broker-real hard halt.
...
- Launch order: `5`
- Branch: `wave3-follow-avoid-mixed-numeric-confluence-v4-2026-06-04`
- Worktree: `/Users/borr/Documents/gtos/worktrees/wave3-follow-avoid-mixed-numeric-confluence-v4-2026-06-04`
- Route directory: `research/operations/wave3_follow_avoid_mixed_numeric_confluence_v4_2026_06_04`
...
```json
{
  ...
  "derived_from_question_ids": [
    "W2Q_FOLLOW_AVOID_MIXED_NUMERIC_CONFLUENCE",
...
replace categorical FOLLOW, AVOID, and MIXED outputs with measurable source-level confluence fields that the probability, selector, and scheduler layers can audit.
...
- `python3 scripts/audit_goal_route_artifacts.py research/operations/wave3_follow_avoid_mixed_numeric_confluence_v4_2026_06_04 --full-jsonl` after creating the route directory.
