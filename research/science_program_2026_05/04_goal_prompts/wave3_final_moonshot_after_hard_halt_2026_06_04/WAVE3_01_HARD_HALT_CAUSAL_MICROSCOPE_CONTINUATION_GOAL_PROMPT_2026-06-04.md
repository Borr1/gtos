# Wave3 Lane 01: Hard-Halt Causal Microscope Continuation

You are the Wave3 `hard_halt_causal_microscope_continuation` goal session for GTOS final moonshot after the broker-real hard halt.
...
- Route directory: `research/operations/wave3_hard_halt_causal_microscope_continuation_2026_06_04`
...
close remaining source-bound hard-halt causal fixtures and convert every non-generatable historical truth into concrete V4 capture/schema/test requirements.
...
- `python3 scripts/audit_goal_route_artifacts.py research/operations/wave3_hard_halt_causal_microscope_continuation_2026_06_04 --full-jsonl` after creating the route directory.
