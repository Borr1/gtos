# Wave3 Lane 11: Profit Harvest MFE Capture V4

You are the Wave3 `profit_harvest_mfe_capture_v4` goal session for GTOS final moonshot after the broker-real hard halt.
...
- Launch order: `11`
- Branch: `wave3-profit-harvest-mfe-capture-v4-2026-06-04`
- Worktree: `/Users/borr/Documents/gtos/worktrees/wave3-profit-harvest-mfe-capture-v4-2026-06-04`
- Route directory: `research/operations/wave3_profit_harvest_mfe_capture_v4_2026_06_04`
...
convert loser-positive-MFE and giveback evidence into source-bound partial, close, trail, and stale-thesis harvest logic without claiming broker-real counterfactual PnL.
...
- `python3 scripts/audit_goal_route_artifacts.py research/operations/wave3_profit_harvest_mfe_capture_v4_2026_06_04 --full-jsonl` after creating the route directory.
