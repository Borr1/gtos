...
|--------|-----------|-----------|---------|-----------|-------------|-------------|----------|-----------|------|--------|----|---------|-----------|
| XAUUSD   |       270 |         7 |       4 |         4 |           0 |           0 |    57.1% |      0.0% |    0 |      0 |   0% |   +0.0R | +0.000R |
...
- Sent to API: 7
- AI returned CANDIDATE: 4 (raw CR: 57.1%)
...
|-------|-----------|----------|-------------|-----------|------|--------|----|---------|-----------|
| 2026-02 |         7 |        4 |           0 |      0.0% |    0 |      0 |   0% |   +0.0R | +0.000R |
...
### 2026-02-19
- API calls: 7 | Trades: 0 | L2 rejected: 4 | Limit blocked: 0
