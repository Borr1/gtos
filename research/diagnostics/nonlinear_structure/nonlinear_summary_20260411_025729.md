# GTOS Nonlinear Structure Analysis — 20260411_025729

Generated: 2026-04-11T03:01:33.183870Z
...
|---|---|---|---|---|---|
| XAUUSD | 14715 | 0.99972 (+1.14) | 0.99957 (+2.70) | **0.99876 (+6.09)** | **0.99564 (+24.66)** |
| US30 | 19999 | 0.99983 (+1.05) | 0.99943 (+2.27) | **0.99841 (+5.71)** | **0.99550 (+25.08)** |
| USDJPY | 19999 | 0.99979 (+1.10) | 0.99961 (+2.42) | **0.99895 (+5.45)** | **0.99655 (+25.20)** |
| GBPJPY | 19999 | 0.99980 (+1.10) | 0.99965 (+2.55) | **0.99889 (+5.93)** | **0.99649 (+25.77)** |
| GBPUSD | 19999 | 0.99982 (+1.01) | 0.99967 (+2.46) | **0.99910 (+6.02)** | **0.99649 (+25.62)** |
...
> Gold H1 permutation entropy (m=5) is **0.99876** (z=+6.088 vs shuffled null). Across all 5 instruments, mean PE (m=5) = **0.99882**. This is significantly below 1.0 (Bonferroni-corrected), indicating the series is close to a pure random walk but with detectable nonlinear structure.
