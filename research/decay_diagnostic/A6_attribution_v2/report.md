...
| regime | UNTAGGED: 33.3% (n=6), bullish: 53.1% (n=49), transitional: 25.0% (n=8) | bearish: 84.6% (n=13), bullish: 4.8% (n=21), transitional: 50.0% (n=10) | +48.30 | [25.43, 60.54] | 0.0001 | 0.0016 |
| **Total attributed (mean)** | | | **+15.09** | | | |
| **Observed delta** | | | **+8.98** | | | |
| **Residual (unexplained)** | | | **-6.11** | | | |
...
| Value | H1 n | H1 wins | H1 WR | H1 mean (post.) | H2 n | H2 wins | H2 WR | H2 mean (post.) | flag |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| UNTAGGED | 6 | 2 | 33.3% | 0.375 | 0 | 0 | - | 0.500 | LOW_N / ABSENT_H2 |
| bearish | 0 | 0 | - | 0.500 | 13 | 11 | 84.6% | 0.800 | LOW_N / ABSENT_H1 |
| bullish | 49 | 26 | 53.1% | 0.529 | 21 | 1 | 4.8% | 0.087 | USED |
| transitional | 8 | 2 | 25.0% | 0.300 | 10 | 5 | 50.0% | 0.500 | LOW_N / LOW_N_H1 |

## Strategic verdict

**Top decay driver:** `regime` (+48.30pp, 29% of total absolute attributable mass; raw_p=0.0001, bonf_p=0.0016).

Ranked by absolute magnitude: `regime` (+48.3pp), `side` (+29.6pp), `bias` (+28.9pp), `kill_zone` (+12.3pp), `setup_grade` (+11.0pp).
...
- Inputs: A1 results.jsonl (C:\Users\MSI\Documents\ai-trading-agent\.claude\worktrees\agent-ad510a06415ac802b\research\**\all_results*.json); n_trades_total=107.
