...
|--------|-----------|-----------|---------|-----------|-------------|-------------|----------|-----------|------|--------|----|---------|-----------|
| XAUUSD   |       300 |        99 |      66 |        47 |          16 |           3 |    66.7% |      3.0% |    0 |      2 |   0% |   -2.0R | -1.000R |
...
- Sent to API: 99
- AI returned CANDIDATE: 66 (raw CR: 66.7%)
...
| 2026-03 |        65 |       44 |           3 |      4.6% |    0 |      2 |   0% |   -2.0R | -1.000R |
...
- API calls: 21 | Trades: 2 | L2 rejected: 0 | Limit blocked: 16
  ...
  - ny 2026-03-02T13:15 → LONG entry=5366.74 SL=5337.40 TP1=5410.75 → **LOSS** -1.0R

### 2026-03-03
- API calls: 20 | Trades: 1 | L2 rejected: 8 | Limit blocked: 0
  - ny 2026-03-03T13:15 → SHORT entry=5305.78 SL=5343.82 TP1=5248.63 → **UNFILLED** ?R
