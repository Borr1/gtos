...
- Orderflow feature candidate rows: 58
- Orderflow synthetic target available: 22
- Orderflow actual realized-R available: 1
- Coverage class counts: {'actual_realized_r_available': 1, 'candidate_join_missing': 23, 'limit_placed_no_broker_close_in_join': 3, 'no_actual_by_design_pre_execution_reject': 31}
- Final outcome counts: {'LIMIT_PLACED': 4, 'REJECTED_GATE1_SAFETY': 1, 'REJECTED_L2': 30, 'none': 23}
- Record path status counts: {'exists': 35, 'no_path': 23}

## Readout

- Orderflow feature candidate rows have actual realized-R coverage 1/58; synthetic target coverage is 22/58.
...
| XAGUSD | 14 | 0 | 0 | {'candidate_join_missing': 14} | {'none': 14} |
