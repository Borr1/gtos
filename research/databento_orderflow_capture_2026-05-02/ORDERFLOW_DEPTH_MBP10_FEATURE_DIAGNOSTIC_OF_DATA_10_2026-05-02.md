...
Sampled MBP-10 ladder-depth features were extracted for the same scoped XAUUSD/NAS100 pilot windows. This tests whether deeper book state opens a defensible next hypothesis.
...
- XAUUSD MBP-10 outcome rows have winner n=2 and loser n=0; no XAUUSD ladder claim can be made.
- NAS100: candidate/context n=11/32, event15 depth10 imbalance delta=0.0225, event15 total-depth delta=-28.0000.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| NAS100 | 11 | 32 | 0.0225 | -0.0053 | -28.0000 | -0.0152 | -2.0000 | -2.0000 |
...
1. Does the NAS100 failure cluster show a repeatable ladder-depth signature in future windows?
