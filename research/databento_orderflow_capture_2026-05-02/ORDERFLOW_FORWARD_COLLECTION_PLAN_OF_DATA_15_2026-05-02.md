...
- Manifest supported candidates within available data cap: 54
- Manifest candidate events by symbol: {'GBPUSD': 21, 'NAS100': 12, 'US30_cash': 1, 'XAGUSD': 10, 'XAUUSD': 10}
- Current unsupported candidate count: 57
- Current unsupported candidate symbols: {'GBPJPY': 23, 'USDJPY': 34}
- Rows after manifest available-end cap (2026-05-01T16:00:00+00:00): 6
- Candidates after available-end cap: 4

## Existing Fetch Coverage

| Schema | executed | blocked | groups | status counts | estimated cost |
|---|---:|---:|---:|---|---:|
| trades | True | False | 25 | {'cached': 20, 'fetched': 5} | $2.909855 |
...
| XAGUSD | 10 | 0 | 0 | {'none': 10} | {'candidate_join_missing': 10} |
