...
| Metric | Count |
|---|---:|
| `trade_records_total` | 26 |
| `trade_records_with_broker_actual_r` | 0 |
| `trade_records_with_internal_execution_block` | 16 |
| `trade_records_with_synthetic_or_path_fields` | 26 |
| `pending_lifecycle_rows` | 877 |
| `pending_lifecycle_internal_filled_rows` | 70 |
| `slippage_rows` | 13 |
| `j46_shadow_rows` | 80 |
