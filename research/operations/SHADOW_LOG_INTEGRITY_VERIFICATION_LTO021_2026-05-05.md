...
**Generated:** `2026-05-05T02:08:49.264449+00:00`
**Overall status:** `OK_WITH_DOCUMENTED_WAITING_LANES`
**Promotion verdict:** `NO_PROMOTION_VERDICT`

## Summary

- JSONL files inspected: `73`
- JSONL rows inspected: `58639`
- Known-schema JSONL files: `50`
...
| `shadow_observer_status.jsonl` | 473 | `2026-05-05T02:05:54.496527+00:00` | `{'shadow_observer_status_v1': 473}` | `OK` |
...
| `strategy_follow_evaluations.jsonl` | 332 | `2026-05-05T02:00:05.227195+00:00` | `{'strategy_follow_evaluation_v1': 332}` | `OK` |
