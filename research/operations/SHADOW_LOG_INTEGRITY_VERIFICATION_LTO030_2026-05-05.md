...
**Generated:** `2026-05-05T01:33:42.938140+00:00`
**Overall status:** `OK_WITH_DOCUMENTED_WAITING_LANES`
**Promotion verdict:** `NO_PROMOTION_VERDICT`

## Summary

- JSONL files inspected: `71`
- JSONL rows inspected: `58459`
- Known-schema JSONL files: `48`
...
| `shadow_observer_status.jsonl` | 463 | `2026-05-05T01:33:37.650571+00:00` | `{'shadow_observer_status_v1': 463}` | `OK` |
...
| `strategy_follow_evaluations.jsonl` | 324 | `2026-05-05T01:30:05.115738+00:00` | `{'strategy_follow_evaluation_v1': 324}` | `OK` |
