...
**Generated:** `2026-05-05T00:44:37.362644+00:00`
**Overall status:** `CHECK_WARNINGS_PRESENT`
**Promotion verdict:** `NO_PROMOTION_VERDICT`

## Summary

- JSONL files inspected: `69`
- JSONL rows inspected: `56099`
- Known-schema JSONL files: `46`
...
| `candidate_registry_audit.jsonl` | 48 | `2026-05-04T20:27:46.937586+00:00` | `{'candidate_registry_audit_v1': 48}` | `OK` |
| `context_control_audit.jsonl` | 48 | `2026-05-04T22:14:53.057473+00:00` | `{'context_control_audit_v1': 48}` | `OK` |
| `context_control_ledger.jsonl` | 48 | `2026-05-04T17:00:26.332632+00:00` | `{'context_control_forward_v1': 48}` | `OK` |
| `d1_bias_lag.jsonl` | 370 | `None` | `{}` | `OK` |
...
| `fvg_ob_confluence.jsonl` | 48 | `2026-05-04T17:00:26.331377+00:00` | `{'fvg_ob_confluence_forward_v1': 48}` | `OK` |
...
| `opportunity_lifecycle_audit.jsonl` | 48 | `2026-05-04T20:53:41.275004+00:00` | `{'opportunity_lifecycle_audit_v1': 48}` | `OK` |
...
| `prefill_delivery_path.jsonl` | 48 | `2026-05-04T17:00:26.330210+00:00` | `{'prefill_delivery_path_v1': 48}` | `OK` |
...
| `shadow_observer_status.jsonl` | 448 | `2026-05-05T00:43:12.048907+00:00` | `{'shadow_observer_status_v1': 448}` | `OK` |
...
| `strategy_follow_candidates.jsonl` | 48 | `2026-05-04T17:00:26.327286+00:00` | `{'strategy_follow_candidate_v1': 48}` | `OK` |
| `strategy_follow_evaluations.jsonl` | 309 | `2026-05-05T00:30:22.238683+00:00` | `{'strategy_follow_evaluation_v1': 309}` | `OK` |
| `trade_index_lifecycle_audit.jsonl` | 312 | `2026-05-04T23:11:21.152648+00:00` | `{'trade_index_lifecycle_audit_v1': 312}` | `OK` |
...
| `v2b_forward_pairs.jsonl` | 48 | `2026-05-04T17:00:26.329070+00:00` | `{'v2b_forward_pair_v1': 48}` | `OK` |
...
|---|---|---|---:|---|
| `MODERATE` | `FRESHNESS_THRESHOLD_EXCEEDED` | `C:\Users\MSI\Documents\ai-trading-agent\shadow_logs\candidate_ltf_path_order.jsonl` |  | latest timestamp age 342.7m exceeds 90m |
| `MODERATE` | `FRESHNESS_THRESHOLD_EXCEEDED` | `C:\Users\MSI\Documents\ai-trading-agent\shadow_logs\candidate_path_follow.jsonl` |  | latest timestamp age 342.7m exceeds 90m |
| `MODERATE` | `FRESHNESS_THRESHOLD_EXCEEDED` | `C:\Users\MSI\Documents\ai-trading-agent\shadow_logs\external_source_blocker_status.jsonl` |  | latest timestamp age 342.5m exceeds 90m |
| `MODERATE` | `FRESHNESS_THRESHOLD_EXCEEDED` | `C:\Users\MSI\Documents\ai-trading-agent\shadow_logs\fvg_ob_confluence_resolutions.jsonl` |  | latest timestamp age 342.6m exceeds 90m |
| `MODERATE` | `FRESHNESS_THRESHOLD_EXCEEDED` | `C:\Users\MSI\Documents\ai-trading-agent\shadow_logs\live_candidate_opportunity_clusters.jsonl` |  | latest timestamp age 342.6m exceeds 90m |
| `MODERATE` | `FRESHNESS_THRESHOLD_EXCEEDED` | `C:\Users\MSI\Documents\ai-trading-agent\shadow_logs\live_candidate_strategy_rollups.jsonl` |  | latest timestamp age 342.6m exceeds 90m |
| `MODERATE` | `FRESHNESS_THRESHOLD_EXCEEDED` | `C:\Users\MSI\Documents\ai-trading-agent\shadow_logs\live_mechanical_strategy_shadow_outcomes.jsonl` |  | latest timestamp age 342.7m exceeds 90m |
| `MODERATE` | `FRESHNESS_THRESHOLD_EXCEEDED` | `C:\Users\MSI\Documents\ai-trading-agent\shadow_logs\missed_opportunity_shadow.jsonl` |  | latest timestamp age 342.6m exceeds 90m |
| `MODERATE` | `FRESHNESS_THRESHOLD_EXCEEDED` | `C:\Users\MSI\Documents\ai-trading-agent\shadow_logs\ml_shadow_status.jsonl` |  | latest timestamp age 342.5m exceeds 90m |
| `MODERATE` | `FRESHNESS_THRESHOLD_EXCEEDED` | `C:\Users\MSI\Documents\ai-trading-agent\shadow_logs\prefill_delivery_path_resolutions.jsonl` |  | latest timestamp age 342.7m exceeds 90m |
| `MODERATE` | `FRESHNESS_THRESHOLD_EXCEEDED` | `C:\Users\MSI\Documents\ai-trading-agent\shadow_logs\proxy_blocker_status.jsonl` |  | latest timestamp age 342.5m exceeds 90m |
| `MODERATE` | `FRESHNESS_THRESHOLD_EXCEEDED` | `C:\Users\MSI\Documents\ai-trading-agent\shadow_logs\v2b_forward_pair_resolutions.jsonl` |  | latest timestamp age 342.7m exceeds 90m |
