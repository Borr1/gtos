...
**Generated:** `2026-05-05T06:07:35.372531+00:00`
**Overall status:** `OK_WITH_DOCUMENTED_WAITING_LANES`
**Promotion verdict:** `NO_PROMOTION_VERDICT`

## Summary

- JSONL files inspected: `87`
- JSONL rows inspected: `59900`
- Known-schema JSONL files: `64`
...
| `mechanical_context_diagnostics_join.jsonl` | 49 | `2026-05-05T04:22:37.586755+00:00` | `{'mechanical_context_diagnostics_join_v1': 49}` | `OK` |
| `missed_opportunity_shadow.jsonl` | 987 | `2026-05-05T02:44:36.811653+00:00` | `{'missed_opportunity_shadow_v1': 987}` | `OK` |
| `ml_shadow_predictions.jsonl` | 49 | `2026-05-05T04:48:06.831792+00:00` | `{'ml_shadow_prediction_v1': 49}` | `OK` |
...
| `shadow_observer_hardening_status.jsonl` | 2 | `2026-05-05T06:07:26.625338+00:00` | `{'shadow_observer_hardening_status_v1': 2}` | `OK` |
| `shadow_observer_status.jsonl` | 544 | `2026-05-05T06:05:57.053924+00:00` | `{'shadow_observer_status_v1': 544}` | `OK` |
...
| `v2_structural_selector_readiness.jsonl` | 3 | `2026-05-05T05:14:50.453465+00:00` | `{'v2_structural_selector_readiness_v1': 3}` | `OK` |
...
| `xauusd_same_market_extension_status.jsonl` | 1 | `2026-05-05T05:29:18.668885+00:00` | `{'xauusd_same_market_extension_status_v1': 1}` | `OK` |
