...
**Generated:** `2026-05-05T01:48:39.601999+00:00`
**Overall status:** `OK_WITH_DOCUMENTED_WAITING_LANES`
**Promotion verdict:** `NO_PROMOTION_VERDICT`

## Summary

- JSONL files inspected: `72`
- JSONL rows inspected: `58475`
- Known-schema JSONL files: `49`
...
| `shadow_observer_status.jsonl` | 467 | `2026-05-05T01:45:43.558560+00:00` | `{'shadow_observer_status_v1': 467}` | `OK` |
...
| `strategy_follow_evaluations.jsonl` | 328 | `2026-05-05T01:45:05.166306+00:00` | `{'strategy_follow_evaluation_v1': 328}` | `OK` |
