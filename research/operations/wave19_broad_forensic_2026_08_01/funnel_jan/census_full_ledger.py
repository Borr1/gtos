#!/usr/bin/env python3
"""Session FA funnel_jan — Task 1 + 5: full physical census of the January
CJ_RECLOCKED_S0R0_V7 MISSED_OPPORTUNITY ledger (153,425 rows, 1.34 GB), streamed
...
OUT = '/Users/borr/GTOSActive/worktrees/wave19-broad-forensic-20260801/research/operations/wave19_broad_forensic_2026_08_01/funnel_jan/'
...
out = {
    'schema': 'gtos.session_fa.funnel_jan.full_census.v1',
    'ledger': LEDGER,
...
ns = {
    'schema': 'gtos.session_fa.funnel_jan.nonscoreable_census.v1',
    'ledger': LEDGER,
    'total_physical_rows': n,
