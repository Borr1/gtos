...
**Generated:** `2026-05-05T02:46:59.950852+00:00`
**Overall status:** `OK_WITH_DOCUMENTED_WAITING_LANES`
**Promotion verdict:** `NO_PROMOTION_VERDICT`

## Summary

- JSONL files inspected: `75`
- JSONL rows inspected: `59520`
- Known-schema JSONL files: `52`
...
| `shadow_observer_status.jsonl` | 485 | `2026-05-05T02:46:15.479122+00:00` | `{'shadow_observer_status_v1': 485}` | `OK` |
...
| `strategy_follow_evaluations.jsonl` | 344 | `2026-05-05T02:45:05.153491+00:00` | `{'strategy_follow_evaluation_v1': 344}` | `OK` |
