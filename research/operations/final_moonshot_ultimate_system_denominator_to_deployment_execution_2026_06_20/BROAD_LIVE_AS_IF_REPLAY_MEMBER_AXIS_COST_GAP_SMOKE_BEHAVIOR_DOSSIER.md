...
Generated: 2026-06-21T10:02:57Z

Broker/live/final authority remains closed. This compares replay-only artifacts.

## Candidate Generation

- Baseline prefix: `BROAD_LIVE_AS_IF_REPLAY_QUALITY_PARITY_BROKER_COST_SMOKE`.
- Repair prefix: `BROAD_LIVE_AS_IF_REPLAY_MEMBER_AXIS_COST_GAP_SMOKE`.
- Baseline generation authority: uncapped_full_authority.
- Repair generation authority: uncapped_full_authority.
- Baseline emitted candidates from decision ledger: 26448.
...
- raw_package_live_as_if:holdout: baseline trades=9 net_r=-1.07398201 cash=-84.8674056 w/l/f=3/6/0; repair trades=5 net_r=-4.36555863 cash=-1641.38364683 w/l/f=0/5/0; delta_net_r=-3.29157662
...
- guarded_causal_admission_repair_v2:holdout: baseline trades=9 net_r=-1.07398201 cash=-84.8674056 w/l/f=3/6/0; repair trades=5 net_r=-4.36555863 cash=-1641.38364683 w/l/f=0/5/0; delta_net_r=-3.29157662
