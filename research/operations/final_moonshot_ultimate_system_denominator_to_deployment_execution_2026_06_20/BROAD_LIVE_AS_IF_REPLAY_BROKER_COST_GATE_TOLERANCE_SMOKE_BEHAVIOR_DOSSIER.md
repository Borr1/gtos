...
Generated: 2026-06-21T07:06:20Z

Broker/live/final authority remains closed. This compares replay-only artifacts.

## Candidate Generation

- Baseline prefix: `BROAD_LIVE_AS_IF_REPLAY_BROKER_COST_GATE_HARD_BLOCK_SMOKE`.
- Repair prefix: `BROAD_LIVE_AS_IF_REPLAY_BROKER_COST_GATE_TOLERANCE_SMOKE`.
...
- raw_package_live_as_if:holdout: baseline trades=11 net_r=-3.54244579 cash=-524.7505294 w/l/f=2/9/0; repair trades=9 net_r=-1.07398201 cash=-84.8674056 w/l/f=3/6/0; delta_net_r=2.46846378
...
- guarded_causal_admission_repair_v2:holdout: baseline trades=11 net_r=-3.54244579 cash=-524.7505294 w/l/f=2/9/0; repair trades=9 net_r=-1.07398201 cash=-84.8674056 w/l/f=3/6/0; delta_net_r=2.46846378
