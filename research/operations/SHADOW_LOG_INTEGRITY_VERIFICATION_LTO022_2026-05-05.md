...
**Generated:** `2026-05-05T02:25:57.866020+00:00`
**Overall status:** `OK_WITH_DOCUMENTED_WAITING_LANES`
**Promotion verdict:** `NO_PROMOTION_VERDICT`

## Summary

- JSONL files inspected: `74`
- JSONL rows inspected: `58657`
- Known-schema JSONL files: `51`
...
| `shadow_observer_status.jsonl` | 478 | `2026-05-05T02:24:04.034234+00:00` | `{'shadow_observer_status_v1': 478}` | `OK` |
...
| `strategy_follow_evaluations.jsonl` | 336 | `2026-05-05T02:15:05.136936+00:00` | `{'strategy_follow_evaluation_v1': 336}` | `OK` |
