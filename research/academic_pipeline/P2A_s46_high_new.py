#!/usr/bin/env python3
"""Phase 2A — Prompt Re-Engineering Test: P2A_s46_high_new
Model: claude-sonnet-4-6, Effort: high, max_tokens: 2000, temperature: 0
...
def evaluate_mso(system_prompt: str, user_message: str, trade_id: str = '') -> dict:
    """Call Sonnet 4.6 with effort=high and the new prompt, return parsed JSON."""
    global cumulative_cost
