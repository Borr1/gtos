...
**YOU are testing effort level: `high`**
...
**Single variable:** Sonnet 4.6 at effort=`high` (temperature=0, no extended thinking).
...
EFFORT_LEVEL = 'high'  # One of: 'medium', 'high', 'max'
...
- **Effort: `high`** — do NOT run other effort levels
...
- `research/academic_pipeline/T2c_effort_high.py` — The analysis script (save your code)
