...
**YOU are testing effort level: `max`**
...
**Single variable:** Sonnet 4.6 at effort=`max` (temperature=0, no extended thinking).
...
EFFORT_LEVEL = 'max'  # One of: 'medium', 'high', 'max'
...
- **Effort: `max`** — do NOT run other effort levels
...
- `research/academic_pipeline/T2c_effort_max.py` — The analysis script (save your code)
