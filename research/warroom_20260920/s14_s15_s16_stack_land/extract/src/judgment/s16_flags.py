"""Default-off S16 Dig/Chair multi-stage guard flags.
...
and stays off the Challenge place scoreboard.
"""
...
def s16_apply_enabled(*, environ: Mapping[str, str] | None = None, force: bool = False) -> bool:
    """APPLY is owner NAME later. Still never place / broker / order_send."""
