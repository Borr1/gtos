...
Output: research/a4_trending_bull_replay_2026-04-28/a4_after_framework_fix_full_cohort_R.json
"""
...
REPLAY_OUTCOMES = RESEARCH_DIR / "after_framework_fix" / "replay_outcomes.jsonl"
STAGE_2_5_RESULTS = RESEARCH_DIR / "fill_simulation_m1_results.json"
OUT_PATH = RESEARCH_DIR / "a4_after_framework_fix_full_cohort_R.json"
OUT_SUMMARY = RESEARCH_DIR / "a4_after_framework_fix_full_cohort_R_SUMMARY.md"
...
def main():
    ...
    caveats_global = [
        ...
        "Multi-framework dispatch fix IS applied (merged 41b4a59). This sim represents A4 cohort with both sl_beyond_ob fix + framework dispatch fix.",
    ]

    sim_walltime = time.time() - t_start

    output = {
        "methodology": "M1 fill sim using POST-framework-fix AI emissions (multi-framework dispatch fix merged)",
